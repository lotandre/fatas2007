...
class Subsession(BaseSubsession):
    def creating_session(self):
        for p in self.in_round(1).get_players():
            ...
            p.participant.vars['red_period_comb1'] = red_period1

            red_period2 = random.choice(Constants.red_seq)
            p.red_period2 = red_period2
            p.participant.vars['red_period_comb2'] = red_period2

            red_period3 = random.choice(Constants.red_seq)
            p.red_period3 = red_period3
            p.participant.vars['red_period_comb3'] = red_period3
...
class Player(BasePlayer):
    ...
    bonus_payoff1 = models.IntegerField(blank=True)
    ...
    bonus_payoff2 = models.IntegerField(blank=True)
    ...
    bonus_payoff3 = models.IntegerField(blank=True)
